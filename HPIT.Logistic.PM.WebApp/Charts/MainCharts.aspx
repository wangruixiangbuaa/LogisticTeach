<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainCharts.aspx.cs" Inherits="HPIT.Logistic.PM.WebApp.Charts.MainCharts" %>
...
<body>
        <div id="map"></div>
        <script src="../js/echarts/main.min.js"></script>
        <script>
            var map = L.map('map');
            var baseLayers = {
