<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Goods.aspx.cs" Inherits="HPIT.Logistic.PM.WebApp.GoodsManage.Goods" %>
                            ...
                            <div class="box-tools pull-right">
                                <div class="has-feedback">
                                    <ul>
                                     ...
                                     <li><asp:Button ID="Button1" runat="server" Text="查询"  CssClass="btn btn-primary" OnClick="Button1_Click"/></li>
                                     </ul>
                                </div>
                            </div>
