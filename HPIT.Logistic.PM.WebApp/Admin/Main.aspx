...
<%--                <form action="#" method="get" class="sidebar-form">
            <div class="input-group">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                    <a href="#">
                    <i class="fa fa-folder"></i> <span>驾驶员管理</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                    </a>
                        <ul class="treeview-menu">
                            ...
                            <li id="admin-driverconfig">
                                <a href="#" aurl="RoleList.aspx" atitle="角色管理" aid="驾驶员配置" class="menu">
                            <i class="fa fa-circle-o"></i> 驾驶员配置
                        </a>
                            </li>
                        </ul>
                    </li>
