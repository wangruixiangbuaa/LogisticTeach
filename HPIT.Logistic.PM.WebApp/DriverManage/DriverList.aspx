<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DriverList.aspx.cs" Inherits="HPIT.Logistic.PM.WebApp.DriverManage.DriverList" %>
                ...
                <div class="box box-primary">
                   ...
                   <%-- <a href="AddUser.aspx" target="_blank">添加用户</a>--%>
                    <div class="box-body">
                            ...
                            <div class="box-tools pull-right">
                                <div class="has-feedback">
                                    <ul>
                                     ...
                                     <li><asp:Button ID="Button1" runat="server" Text="查询"  CssClass="btn btn-primary" OnClick="Btn_Search"/></li>
                                     </ul>
                                </div>
                            </div>
                        ...
                        <ItemTemplate>
                           <tr>
                             <td><%#((dynamic)Container.DataItem).Name%></td>
                             <td><%#((dynamic)Container.DataItem).Sex%></td>
                             <td><%#((dynamic)Container.DataItem).Birth%></td>
                             <td><%#((dynamic)Container.DataItem).Phone%></td>
                             <td><%#((dynamic)Container.DataItem).IDCard%></td>
